...
class DanhmucController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            'tendanhmuc.unique'=>'Tên danh mục đã có, xin nhập tên khác',
            'tendanhmuc.required'=>'Tên danh mục phải bắt buộc nhập',
            'slug_danhmuc.unique'=>'Slug danh mục đã có, xin nhập slug khác',
            'slug_danhmuc.required'=>'Tên slug phải bắt buộc nhập',
    ...
    public function update(Request $request, $id)
    {
        $data= $request->validate(
            ...
            [
                'tendanhmuc.required'=>'Tên danh mục phải bắt buộc nhập',
                'slug_danhmuc.required'=>'Slug danh mục phải bắt buộc nhập',
                'mota.required'=>'Mô tả danh mục phải bắt buộc nhập',
            ]   
            );
