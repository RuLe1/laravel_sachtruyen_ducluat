...
class TheLoaiController extends Controller
{
    ...
    {
        $theloai = TheLoai::with('truyen')->orderBy('id','desc')->get();
    ...
    public function store(Request $request)
    {
        $data= $request->validate(
            ...
            [
            'tentheloai.unique'=>'Tên thể loại đã có, xin nhập tên khác',
            'tentheloai.required'=>'Tên thể loại phải bắt buộc nhập',
            'slug_theloai.unique'=>'Slug thể loại đã có, xin nhập slug khác',
            'slug_theloai.required'=>'Tên slug phải bắt buộc nhập',
            'mota.required'=>'Mô tả thể loại phải bắt buộc nhập',
            ]   
            );
            $theloai = new TheLoai();
    ...
    public function edit($id)
    {
        ...
        return view('admincp.theloai.edit')->with(compact('truyen','theloai'));
    }
    ...
    public function update(Request $request, $id)
    {
        $data= $request->validate(
            ...
            'slug_theloai.unique'=>'Slug thể loại đã có, xin nhập slug khác',
            'slug_theloai.required'=>'Tên slug phải bắt buộc nhập',
            'mota.required'=>'Mô tả danh mục phải bắt buộc nhập',
            ]   
            );
            $theloai = TheLoai::find($id);
            $theloai -> tentheloai = $data['tentheloai'];
