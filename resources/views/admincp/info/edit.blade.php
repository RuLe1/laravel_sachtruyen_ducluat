                    ...
                    <form method="POST" action="{{route('info.update',[$info->id])}}"  enctype='multipart/form-data'>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" value="{{$info->tieude_footer}}" name="tieude_footer" aria-describedby="emailHelp" placeholder="">{{$info->tieude_footer}}</textarea>
                        
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Mô tả website</label>
                        <textarea type="text" class="form-control" value="{{$info->mota}}" name="mota" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả website">{{$info->mota}}</textarea>
